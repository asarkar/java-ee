package name.abhijitsarkar.javaee.availability.domain;

import static java.time.format.DateTimeFormatter.ISO_LOCAL_DATE_TIME;

import java.time.LocalDateTime;

import name.abhijitsarkar.javaee.availability.representation.SlotDateTimeDeserializer;
import name.abhijitsarkar.javaee.availability.representation.SlotDateTimeSerializer;
