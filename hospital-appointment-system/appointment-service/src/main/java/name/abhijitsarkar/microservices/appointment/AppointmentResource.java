...
import static name.abhijitsarkar.microservices.appointment.representation.AppointmentRepresentationFactory.APPOINTMENT_PATH;
import static name.abhijitsarkar.microservices.appointment.representation.AppointmentRepresentationFactory.BASE_PATH;
...
import name.abhijitsarkar.microservices.appointment.provider.PatientIdValidated;
import name.abhijitsarkar.microservices.appointment.provider.SlotIdValidated;
import name.abhijitsarkar.microservices.appointment.representation.AppointmentRepresentationFactory;
import name.abhijitsarkar.microservices.appointment.service.AppointmentService;
