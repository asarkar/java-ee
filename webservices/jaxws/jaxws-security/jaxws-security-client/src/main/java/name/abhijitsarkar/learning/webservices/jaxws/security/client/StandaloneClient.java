...
import name.abhijitsarkar.learning.webservices.jaxws.security.ejb.CalculatorEJBRemote;
...
public class StandaloneClient {
	...
	private static final String GLOBAL_JNDI_NAME = "java:global/"
			...
			+ "CalculatorEJB!"
			+ "name.abhijitsarkar.learning.webservices.jaxws.security.ejb.CalculatorEJBRemote";
