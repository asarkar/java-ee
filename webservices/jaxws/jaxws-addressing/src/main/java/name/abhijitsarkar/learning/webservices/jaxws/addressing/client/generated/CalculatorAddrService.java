 ...
 * 
 */
@WebServiceClient(name = "CalculatorAddrService", targetNamespace = "http://addressing.jaxws.webservices.learning.abhijitsarkar.name/", wsdlLocation = "http://localhost:8080/jaxws-addressing/CalculatorAddrService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORADDRSERVICE_QNAME = new QName("http://addressing.jaxws.webservices.learning.abhijitsarkar.name/", "CalculatorAddrService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxws-addressing/CalculatorAddrService?wsdl");
    ...
    public CalculatorAddr getCalculatorAddrPort() {
        return super.getPort(new QName("http://addressing.jaxws.webservices.learning.abhijitsarkar.name/", "CalculatorAddrPort"), CalculatorAddr.class);
    }
    ...
    public CalculatorAddr getCalculatorAddrPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://addressing.jaxws.webservices.learning.abhijitsarkar.name/", "CalculatorAddrPort"), CalculatorAddr.class, features);
    }
