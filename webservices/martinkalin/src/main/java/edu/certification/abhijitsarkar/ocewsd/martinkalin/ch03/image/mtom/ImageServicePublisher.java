 ...
 * edu.certification.abhijitsarkar
 * .ocewsd.martinkalin.ch03.image.ImageServiceImpl. For now, the service is
 * published at localhost, and at port number 9876, as this port is likely
 * available on any desktop machine. The publication path is /ch03/image/mtom,
 * an arbitrary name.
 * 
 ...
 * http://localhost:9876/ch03/image/mtom?wsdl
 * 
...
public class ImageServicePublisher {
	public static void main(String[] args) {
		...
		final String PUBLICATION_URL = "http://localhost:9876/ch03/image/mtom";
		...
		// endpoint.publish(PUBLICATION_URL);
	}
}
