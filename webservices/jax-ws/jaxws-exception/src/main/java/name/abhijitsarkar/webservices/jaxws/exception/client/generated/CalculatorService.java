 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://exception.jaxws.webservices.abhijitsarkar.name/", wsdlLocation = "http://localhost:8080/jaxws-exception/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://exception.jaxws.webservices.abhijitsarkar.name/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxws-exception/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://exception.jaxws.webservices.abhijitsarkar.name/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exception.jaxws.webservices.abhijitsarkar.name/", "CalculatorPort"), Calculator.class, features);
    }
