package name.abhijitsarkar.webservices.jaxrs.security.pgm.config;
...
import name.abhijitsarkar.webservices.jaxrs.security.pgm.CalculatorEJB;
import name.abhijitsarkar.webservices.jaxrs.security.pgm.auth.MustBeCelebrityFeature;
