...
public interface RandService {
     ...
     * 
     * @return
     *     returns javax.xml.ws.Response<com.github.mkalin.jwsur2.ch4.rand.client.async.Next1Response>
     */
    @WebMethod(operationName = "next1")
    @RequestWrapper(localName = "next1", targetNamespace = "http://rand.ch4.jwsur2.mkalin.github.com/", className = "com.github.mkalin.jwsur2.ch4.rand.client.async.Next1")
    @ResponseWrapper(localName = "next1Response", targetNamespace = "http://rand.ch4.jwsur2.mkalin.github.com/", className = "com.github.mkalin.jwsur2.ch4.rand.client.async.Next1Response")
