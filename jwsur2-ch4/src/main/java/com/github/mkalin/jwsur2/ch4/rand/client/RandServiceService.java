    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.github.mkalin.jwsur2.ch4.rand.client.RandServiceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.github.mkalin.jwsur2.ch4.rand.client.RandServiceService.class.getResource(".");
