    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(name.abhijitsarkar.learning.webservices.jaxws.calculator.contractfirst.client.generated.CalculatorService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = name.abhijitsarkar.learning.webservices.jaxws.calculator.contractfirst.client.generated.CalculatorService.class.getResource(".");
