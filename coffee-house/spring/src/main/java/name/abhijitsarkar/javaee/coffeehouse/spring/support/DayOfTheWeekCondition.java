...
package name.abhijitsarkar.javaee.coffeehouse.spring.support;
...
public class DayOfTheWeekCondition implements Condition {
    ...
    public boolean matches(final ConditionContext context, final AnnotatedTypeMetadata metadata) {
        ...
        final ConditionalOnDayOfTheWeek.DayOfTheWeek dayOfTheWeek = (ConditionalOnDayOfTheWeek.DayOfTheWeek) attributes.get("value");
